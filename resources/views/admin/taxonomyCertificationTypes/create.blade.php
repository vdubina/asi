...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.taxonomyCertificationType.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.taxonomy-certification-types.store") }}" enctype="multipart/form-data">
            @csrf
          ...
          return loader.file
            .then(function (file) {
              return new Promise(function(resolve, reject) {
                ...
                xhr.open('POST', '{{ route('admin.taxonomy-certification-types.storeCKEditorImages') }}', true);
                ...
                data.append('crud_id', '{{ $taxonomyCertificationType->id ?? 0 }}');
                xhr.send(data);
              });
            })
        }
