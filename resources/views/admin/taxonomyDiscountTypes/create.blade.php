...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.taxonomyDiscountType.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.taxonomy-discount-types.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('field_amount') ? 'is-invalid' : '' }}" type="number" name="field_amount" id="field_amount" value="{{ old('field_amount', '') }}" step="1" required>
          ...
          return loader.file
            .then(function (file) {
              return new Promise(function(resolve, reject) {
                ...
                xhr.open('POST', '{{ route('admin.taxonomy-discount-types.storeCKEditorImages') }}', true);
                ...
                data.append('crud_id', '{{ $taxonomyDiscountType->id ?? 0 }}');
                xhr.send(data);
              });
            })
        }
