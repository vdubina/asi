...
@can('taxonomy_practice_type_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route('admin.taxonomy-practice-types.create') }}">
                {{ trans('global.add') }} {{ trans('cruds.taxonomyPracticeType.title_singular') }}
            </a>
        </div>
    </div>
@endcan
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class="table compact table-hover datatable datatable-TaxonomyPracticeType">
                <thead>
                    <tr>
                        <th width="10">
...
@can('taxonomy_practice_type_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('admin.taxonomy-practice-types.massDestroy') }}",
