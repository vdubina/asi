...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.taxonomyPracticeType.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.taxonomy-practice-types.store") }}" enctype="multipart/form-data">
            @csrf
          ...
          return loader.file
            .then(function (file) {
              return new Promise(function(resolve, reject) {
                ...
                xhr.open('POST', '{{ route('admin.taxonomy-practice-types.storeCKEditorImages') }}', true);
                ...
                data.append('crud_id', '{{ $taxonomyPracticeType->id ?? 0 }}');
                xhr.send(data);
              });
            })
        }
