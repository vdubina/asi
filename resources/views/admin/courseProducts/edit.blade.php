...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.courseProduct.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.course-products.update", [$courseProduct->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                <label class="required" for="title">{{ trans('cruds.courseProduct.fields.title') }}</label>
                <input class="form-control {{ $errors->has('title') ? 'is-invalid' : '' }}" type="text" name="title" id="title" value="{{ old('title', $courseProduct->title) }}" required>
                @if($errors->has('title'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('sku') ? 'is-invalid' : '' }}" type="text" name="sku" id="sku" value="{{ old('sku', $courseProduct->sku) }}" required>
                @if($errors->has('sku'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('commerce_price') ? 'is-invalid' : '' }}" type="number" name="commerce_price" id="commerce_price" value="{{ old('commerce_price', $courseProduct->commerce_price) }}" step="0.01" required>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('status') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="status" id="status" value="1" {{ $courseProduct->status || old('status', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('field_description') ? 'is-invalid' : '' }}" name="field_description" id="field_description">{!! old('field_description', $courseProduct->field_description) !!}</textarea>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('field_course_length') ? 'is-invalid' : '' }}" name="field_course_length" id="field_course_length" required>
                    ...
                    @foreach(App\Models\CourseProduct::FIELD_COURSE_LENGTH_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('field_course_length', $courseProduct->field_course_length) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('field_offsiteid') ? 'is-invalid' : '' }}" type="number" name="field_offsiteid" id="field_offsiteid" value="{{ old('field_offsiteid', $courseProduct->field_offsiteid) }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('field_supplier_code') ? 'is-invalid' : '' }}" type="text" name="field_supplier_code" id="field_supplier_code" value="{{ old('field_supplier_code', $courseProduct->field_supplier_code) }}" required>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('field_is_ondemand') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="field_is_ondemand" id="field_is_ondemand" value="1" {{ $courseProduct->field_is_ondemand || old('field_is_ondemand', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('field_disk_availability') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="field_disk_availability" id="field_disk_availability" value="1" {{ $courseProduct->field_disk_availability || old('field_disk_availability', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('field_dental_report_text') ? 'is-invalid' : '' }}" type="text" name="field_dental_report_text" id="field_dental_report_text" value="{{ old('field_dental_report_text', $courseProduct->field_dental_report_text) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('field_download_availability') ? 'is-invalid' : '' }}" type="text" name="field_download_availability" id="field_download_availability" value="{{ old('field_download_availability', $courseProduct->field_download_availability) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('field_standard_credit_hours') ? 'is-invalid' : '' }}" type="number" name="field_standard_credit_hours" id="field_standard_credit_hours" value="{{ old('field_standard_credit_hours', $courseProduct->field_standard_credit_hours) }}" step="1">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('field_course_type') ? 'is-invalid' : '' }}" name="field_course_type_id" id="field_course_type_id" required>
                    @foreach($field_course_types as $id => $entry)
                        <option value="{{ $id }}" {{ (old('field_course_type_id') ? old('field_course_type_id') : $courseProduct->field_course_type->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('field_course_credit_type') ? 'is-invalid' : '' }}" name="field_course_credit_type_id" id="field_course_credit_type_id" required>
                    @foreach($field_course_credit_types as $id => $entry)
                        <option value="{{ $id }}" {{ (old('field_course_credit_type_id') ? old('field_course_credit_type_id') : $courseProduct->field_course_credit_type->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('field_practice_type') ? 'is-invalid' : '' }}" name="field_practice_type_id" id="field_practice_type_id" required>
                    @foreach($field_practice_types as $id => $entry)
                        <option value="{{ $id }}" {{ (old('field_practice_type_id') ? old('field_practice_type_id') : $courseProduct->field_practice_type->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('field_media_provider') ? 'is-invalid' : '' }}" name="field_media_provider_id" id="field_media_provider_id" required>
                    @foreach($field_media_providers as $id => $entry)
                        <option value="{{ $id }}" {{ (old('field_media_provider_id') ? old('field_media_provider_id') : $courseProduct->field_media_provider->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('field_media_delivery_type') ? 'is-invalid' : '' }}" name="field_media_delivery_type_id" id="field_media_delivery_type_id" required>
                    @foreach($field_media_delivery_types as $id => $entry)
                        <option value="{{ $id }}" {{ (old('field_media_delivery_type_id') ? old('field_media_delivery_type_id') : $courseProduct->field_media_delivery_type->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('field_web_category') ? 'is-invalid' : '' }}" name="field_web_category_id" id="field_web_category_id" required>
                    @foreach($field_web_categories as $id => $entry)
                        <option value="{{ $id }}" {{ (old('field_web_category_id') ? old('field_web_category_id') : $courseProduct->field_web_category->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('field_topics_nodes') ? 'is-invalid' : '' }}" name="field_topics_nodes[]" id="field_topics_nodes" multiple>
                    @foreach($field_topics_nodes as $id => $field_topics_node)
                        <option value="{{ $id }}" {{ (in_array($id, old('field_topics_nodes', [])) || $courseProduct->field_topics_nodes->contains($id)) ? 'selected' : '' }}>{{ $field_topics_node }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                @include('partials.buttons.back', ['url'=>route('admin.course-products.index')])
            </div>
        </form>
    </div>
</div>
...
@section('scripts')
    @include('partials.scripts.simpleUpload',['route'=>'course-products','id'=>$courseProduct->id,])
@endsection
