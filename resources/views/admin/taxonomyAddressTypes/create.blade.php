...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.taxonomyAddressType.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.taxonomy-address-types.store") }}" enctype="multipart/form-data">
            @csrf
          ...
          return loader.file
            .then(function (file) {
              return new Promise(function(resolve, reject) {
                ...
                xhr.open('POST', '{{ route('admin.taxonomy-address-types.storeCKEditorImages') }}', true);
                ...
                data.append('crud_id', '{{ $taxonomyAddressType->id ?? 0 }}');
                xhr.send(data);
              });
            })
        }
