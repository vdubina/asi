...
@can('taxonomy_profession_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route('admin.taxonomy-professions.create') }}">
                {{ trans('global.add') }} {{ trans('cruds.taxonomyProfession.title_singular') }}
            </a>
        </div>
    </div>
@endcan
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-TaxonomyProfession">
                <thead>
                    <tr>
                        <th width="10">
