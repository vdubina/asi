...
@can('taxonomy_tag_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route('admin.taxonomy-tags.create') }}">
                {{ trans('global.add') }} {{ trans('cruds.taxonomyTag.title_singular') }}
            </a>
        </div>
    </div>
@endcan
...
@can('taxonomy_tag_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('admin.taxonomy-tags.massDestroy') }}",
