    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.course-topics.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('field_speakers') ? 'is-invalid' : '' }}" name="field_speakers" id="field_speakers">{{ old('field_speakers') }}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('field_ad_code') ? 'is-invalid' : '' }}" type="text" name="field_ad_code" id="field_ad_code" value="{{ old('field_ad_code', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('field_supplier_code') ? 'is-invalid' : '' }}" type="text" name="field_supplier_code" id="field_supplier_code" value="{{ old('field_supplier_code', '') }}">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('field_on_sale') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="field_on_sale" id="field_on_sale" value="1" {{ old('field_on_sale', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('field_position') ? 'is-invalid' : '' }}" type="text" name="field_position" id="field_position" value="{{ old('field_position', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('field_volume') ? 'is-invalid' : '' }}" type="text" name="field_volume" id="field_volume" value="{{ old('field_volume', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('field_issue') ? 'is-invalid' : '' }}" type="text" name="field_issue" id="field_issue" value="{{ old('field_issue', '') }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('field_armscode') ? 'is-invalid' : '' }}" name="field_armscode_id" id="field_armscode_id">
                    @foreach($field_armscodes as $id => $entry)
                        <option value="{{ $id }}" {{ old('field_armscode_id') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('field_ad_service') ? 'is-invalid' : '' }}" name="field_ad_service_id" id="field_ad_service_id">
                    @foreach($field_ad_services as $id => $entry)
                        <option value="{{ $id }}" {{ old('field_ad_service_id') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('field_media_provider_topic') ? 'is-invalid' : '' }}" type="number" name="field_media_provider_topic" id="field_media_provider_topic" value="{{ old('field_media_provider_topic', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('field_aana_expiration_date') ? 'is-invalid' : '' }}" type="text" name="field_aana_expiration_date" id="field_aana_expiration_date" value="{{ old('field_aana_expiration_date') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('field_expiration_date') ? 'is-invalid' : '' }}" type="text" name="field_expiration_date" id="field_expiration_date" value="{{ old('field_expiration_date') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('field_price') ? 'is-invalid' : '' }}" type="number" name="field_price" id="field_price" value="{{ old('field_price', '') }}" step="0.01">
...
@section('scripts')
    @include('partials.scripts.simpleUpload',['route'=>'course-topics'])
@endsection
