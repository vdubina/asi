...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.taxonomyCouponCode.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.taxonomy-coupon-codes.update", [$taxonomyCouponCode->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                <label class="required" for="name">{{ trans('cruds.taxonomyCouponCode.fields.name') }}</label>
                <input class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}" type="text" name="name" id="name" value="{{ old('name', $taxonomyCouponCode->name) }}" required>
                @if($errors->has('name'))
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('description') ? 'is-invalid' : '' }}" name="description" id="description">{!! old('description', $taxonomyCouponCode->description) !!}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('field_offsiteid') ? 'is-invalid' : '' }}" type="number" name="field_offsiteid" id="field_offsiteid" value="{{ old('field_offsiteid', $taxonomyCouponCode->field_offsiteid) }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('field_value') ? 'is-invalid' : '' }}" type="number" name="field_value" id="field_value" value="{{ old('field_value', $taxonomyCouponCode->field_value) }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('field_type') ? 'is-invalid' : '' }}" type="number" name="field_type" id="field_type" value="{{ old('field_type', $taxonomyCouponCode->field_type) }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('field_max_uses') ? 'is-invalid' : '' }}" type="number" name="field_max_uses" id="field_max_uses" value="{{ old('field_max_uses', $taxonomyCouponCode->field_max_uses) }}" step="1" required>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('field_inactive') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="field_inactive" id="field_inactive" value="1" {{ $taxonomyCouponCode->field_inactive || old('field_inactive', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                @foreach(App\Models\TaxonomyCouponCode::FIELD_EXCLUSIVE_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('field_exclusive') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="field_exclusive_{{ $key }}" name="field_exclusive" value="{{ $key }}" {{ old('field_exclusive', $taxonomyCouponCode->field_exclusive) === (string) $key ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('field_date_start') ? 'is-invalid' : '' }}" type="text" name="field_date_start" id="field_date_start" value="{{ old('field_date_start', $taxonomyCouponCode->field_date_start) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('field_date_end') ? 'is-invalid' : '' }}" type="text" name="field_date_end" id="field_date_end" value="{{ old('field_date_end', $taxonomyCouponCode->field_date_end) }}">
