...
@can('taxonomy_media_delivery_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route('admin.taxonomy-media-deliveries.create') }}">
                {{ trans('global.add') }} {{ trans('cruds.taxonomyMediaDelivery.title_singular') }}
            </a>
        </div>
    </div>
@endcan
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-TaxonomyMediaDelivery">
                <thead>
                    <tr>
                        <th width="10">
...
@can('taxonomy_media_delivery_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('admin.taxonomy-media-deliveries.massDestroy') }}",
