...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.taxonomyPaymentType.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.taxonomy-payment-types.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('field_cc') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="field_cc" id="field_cc" value="1" {{ old('field_cc', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('field_online_only') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="field_online_only" id="field_online_only" value="1" {{ old('field_online_only', 0) == 1 ? 'checked' : '' }}>
