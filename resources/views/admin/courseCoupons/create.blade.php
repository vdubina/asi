...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.courseCoupon.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.course-coupons.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('uses') ? 'is-invalid' : '' }}" type="number" name="uses" id="uses" value="{{ old('uses', '1') }}" step="1">
                @if($errors->has('uses'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('field_offsiteid') ? 'is-invalid' : '' }}" type="text" name="field_offsiteid" id="field_offsiteid" value="{{ old('field_offsiteid', '') }}" required>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('type') ? 'is-invalid' : '' }}" name="type" id="type" required>
                    ...
                    @foreach(App\Models\CourseCoupon::TYPE_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('type', 'percent') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
                @if($errors->has('type'))
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('on_demand') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="on_demand" id="on_demand" value="1" {{ old('on_demand', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('invert') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="invert" id="invert" value="1" {{ old('invert', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('date_from') ? 'is-invalid' : '' }}" type="text" name="date_from" id="date_from" value="{{ old('date_from') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('date_to') ? 'is-invalid' : '' }}" type="text" name="date_to" id="date_to" value="{{ old('date_to') }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('media_type') ? 'is-invalid' : '' }}" name="media_type_id" id="media_type_id">
                    @foreach($media_types as $id => $entry)
                        <option value="{{ $id }}" {{ old('media_type_id') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('prev_days_less') ? 'is-invalid' : '' }}" type="number" name="prev_days_less" id="prev_days_less" value="{{ old('prev_days_less', '1') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('prev_days_more') ? 'is-invalid' : '' }}" type="number" name="prev_days_more" id="prev_days_more" value="{{ old('prev_days_more', '1') }}" step="1">
