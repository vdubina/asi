<div class="m-3">
    @can('course_topic_create')
        <div style="margin-bottom: 10px;" class="row">
            <div class="col-lg-12">
                <a class="btn btn100 btn-success" href="{{ route('admin.course-topics.create') }}">
    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class=" table table-striped compact table-hover datatable datatable-fieldMediaProviderCourseTopics">
                    <thead>
                        <tr>
                            <th width="10">
...
@endcan
  ...
  let table = $('.datatable-fieldMediaProviderCourseTopics:not(.ajaxTable)').DataTable({ buttons: dtButtons })
