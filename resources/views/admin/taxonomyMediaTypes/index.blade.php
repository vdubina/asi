...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-TaxonomyMediaType">
                <thead>
                    <tr>
                        <th width="10">
...
@can('taxonomy_media_type_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('admin.taxonomy-media-types.massDestroy') }}",
...
@endcan
  ...
  let table = $('.datatable-TaxonomyMediaType:not(.ajaxTable)').DataTable({ buttons: dtButtons })
