...
@can('taxonomy_credit_type_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route('admin.taxonomy-credit-types.create') }}">
                {{ trans('global.add') }} {{ trans('cruds.taxonomyCreditType.title_singular') }}
            </a>
        </div>
    </div>
@endcan
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-TaxonomyCreditType">
                <thead>
                    <tr>
                        <th width="10">
...
@can('taxonomy_credit_type_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('admin.taxonomy-credit-types.massDestroy') }}",
...
@endcan
  ...
  let table = $('.datatable-TaxonomyCreditType:not(.ajaxTable)').DataTable({ buttons: dtButtons })
