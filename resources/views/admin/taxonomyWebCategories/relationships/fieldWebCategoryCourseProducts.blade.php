    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class=" table table-striped compact table-hover datatable datatable-fieldWebCategoryCourseProducts">
                    <thead>
                        <tr>
                            <th width="10">
...
@endcan
  ...
  let table = $('.datatable-fieldWebCategoryCourseProducts:not(.ajaxTable)').DataTable({ buttons: dtButtons })
