...
@can('taxonomy_web_category_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route('admin.taxonomy-web-categories.create') }}">
                {{ trans('global.add') }} {{ trans('cruds.taxonomyWebCategory.title_singular') }}
            </a>
        </div>
    </div>
@endcan
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-TaxonomyWebCategory">
                <thead>
                    <tr>
                        <th width="10">
