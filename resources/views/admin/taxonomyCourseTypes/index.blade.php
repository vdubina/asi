...
@can('taxonomy_course_type_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route('admin.taxonomy-course-types.create') }}">
                {{ trans('global.add') }} {{ trans('cruds.taxonomyCourseType.title_singular') }}
            </a>
        </div>
    </div>
@endcan
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-TaxonomyCourseType">
                <thead>
                    <tr>
                        <th width="10">
...
@can('taxonomy_course_type_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('admin.taxonomy-course-types.massDestroy') }}",
...
@endcan
  ...
  let table = $('.datatable-TaxonomyCourseType:not(.ajaxTable)').DataTable({ buttons: dtButtons })
